...
Ni_R2 = zeros(iter_max, 1);
idx_R2 = zeros(iter_max, 1);
dT_R2 = zeros(iter_max, 1);
...
figure(2)
histogram(idx_R2(:),'Normalization','probability')

figure(3)
histogram(Ni_R2(idx_R2 == 1),'Normalization','probability')

figure(4)
histogram(Ni_R2(idx_R2 == 2),'Normalization','probability')
...
xi = zeros(nx,1);
xi(10) = 1;
a = 0.1*Pr2o_11*xi + 0.9*Pr2o_12*xi;
b = 0.1*Pr2o_21*xi + 0.9*Pr2o_22*xi;
